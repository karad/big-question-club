...
このガイドは、[仕様](./spec_ja.md)の成功基準SC-001からSC-005を実ブラウザで確認し、Go/No-Goを記録するための手順である。APIとToolの返却形式は[本人確認契約](./contracts/who-am-i_ja.md)を参照する。実装前のGoogle Cloud・Cloudflare準備は[Google OAuth・Cloudflare事前準備手順](./oauth-cloudflare-setup_ja.md)を参照する。
