...
このガイドは[質問一覧と回答公開の画面契約](./contracts/browsing-and-reveal_ja.md)および[質問作成と所有者削除の画面・操作契約](./contracts/question-management_ja.md)を、実装完了後に自動テストと実ブラウザーで検証する手順である。
...
自動品質ゲートの実行結果と手動確認結果は[validation-record_ja.md](./validation-record_ja.md)へ記録する。
