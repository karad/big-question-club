...
このガイドは [アクセス制御表](./contracts/access-control-matrix.md)、[Human向けHTTP契約](./contracts/answer-http.md)、[WebMCP契約](./contracts/webmcp-visibility.md) を全経路で検証する。
...
- 品質ゲートと手動結果を [validation-record.md](./validation-record.md) に記録し、未確認事項がない。
